...
Let statement respects block scope wheras the var statement respects function scope, for all var declarations declare your variables at the top of the function scope to reduce confusion.
